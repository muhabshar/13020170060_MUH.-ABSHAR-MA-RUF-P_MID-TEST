package com.Abshar.TugasProject4.helper;
...
public class TvShowRecyclerViewHolder extends RecyclerView.ViewHolder {
    public ImageView image;
    public TextView title, detail;
    public Button btn_hapus;
    public CardView cardView;
    public TvShowRecyclerViewHolder(@NonNull View itemView, int viewType) {
        super(itemView);
        if (viewType == 1){
